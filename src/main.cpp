...
const string strMessageMagic = "EquinoxCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "EquinoxCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Tue, 09 Sep 2014 19:09:13 GMT";
        CTransaction txNew;
        txNew.nTime = 1410289756;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1410289756;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2000867;
		if(fTestNet)
        {
            block.nNonce   = 2000867;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xbe60b3122938a52748a065100178c0cfc4562b9a76ce938943ac44dae8e503ca"));
        block.print();
